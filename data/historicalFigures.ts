...
export const HISTORICAL_FIGURES: HistoricalFigure[] = [
  ...
  },
  {
    ...
    portraitArchetype: 'artist',
    spawnWeight: 12,
    preferredBiomes: ['GARDEN', 'CAFE', 'VILLAGE'],
    biomeMultiplier: 3,
    maxInstances: 1,
    description: 'A red-bearded painter with haunted eyes and paint-stained clothes.',
    historicalNote: 'In 1889, Van Gogh was in the Saint-Rémy asylum but may have briefly visited Paris. He died in 1890.',
    dialogueStyle: 'Intense, emotional, speaks passionately of nature and color.',
    knownFor: ['Starry Night', 'Sunflowers', 'Post-Impressionism'],
    combatStats: { wit: 14, observation: 19, composure: 8 }
  },
  {
    id: 'edvard_grieg',
    name: 'Edvard Grieg',
  ...
  },
  {
    ...
    portraitArchetype: 'elderly_gentleman',
    spawnWeight: 8,
    preferredBiomes: ['GALERIE', 'VILLAGE', 'SALON'],
    biomeMultiplier: 4,
    maxInstances: 1,
    description: 'The elderly Javanese painter, a pioneer of Indonesian art in European style.',
    historicalNote: 'Though elderly, Saleh may have attended; he died in 1880, but his legacy influenced the Javanese pavilion.',
    dialogueStyle: 'Dignified, speaks of bridging East and West through art.',
    knownFor: ['Romantic paintings', 'First Indonesian modern artist', 'Royal portraiture'],
    combatStats: { wit: 15, observation: 17, composure: 16 }
  },
  ...
  },
  {
    ...
    biomeMultiplier: 4,
    maxInstances: 1,
    description: 'A serious young Polish woman, fascinated by the scientific exhibits.',
    historicalNote: 'In 1889, Marie was still in Poland; she would move to Paris in 1891 to study physics.',
    dialogueStyle: 'Quiet, determined, asks probing questions about science.',
    knownFor: ['Radioactivity (future)', 'Nobel Prizes (future)', 'Scientific dedication'],
    combatStats: { wit: 17, observation: 18, composure: 16 }
  },
  ...
  },
  {
    ...
    biomeMultiplier: 5,
    maxInstances: 1,
    description: 'The legendary Lakota leader, dignified and watchful.',
    historicalNote: 'Sitting Bull had toured with Buffalo Bill\'s show in 1885; he may have been present in Paris.',
    dialogueStyle: 'Speaks through an interpreter, profound and measured. Distrusts white promises.',
    knownFor: ['Little Bighorn', 'Resistance', 'Spiritual leader'],
    combatStats: { wit: 16, observation: 18, composure: 19 }
  },
  {
    id: 'cleo_de_merode',
    name: 'Cléo de Mérode',
